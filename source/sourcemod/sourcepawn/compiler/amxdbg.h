...
int AMXAPI dbg_GetFunctionAddress(AMX_DBG* amxdbg, const char* funcname, const char* filename,
                                  ucell* address);
...
int AMXAPI dbg_GetVariable(AMX_DBG* amxdbg, const char* symname, ucell scopeaddr,
                           const AMX_DBG_SYMBOL** sym);
int AMXAPI dbg_GetArrayDim(AMX_DBG* amxdbg, const AMX_DBG_SYMBOL* sym,
