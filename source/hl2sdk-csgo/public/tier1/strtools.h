...
template <size_t maxLenInChars> int V_sprintf_safe( char (&pDest)[maxLenInChars], const char *pFormat, ... ) FMTFUNCTION( 2, 3 );
template <size_t maxLenInChars> int V_sprintf_safe( char (&pDest)[maxLenInChars], const char *pFormat, ... )
{
	va_list params;
